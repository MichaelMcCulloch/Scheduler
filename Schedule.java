...
public class Schedule implements Comparable<Schedule> {
    ...
    */
    ...
    public String prettyPrint() {
        ...
        String out = "Eval-value: " + score + "\n";
        for (Pair<Course, Slot> pair : list) {
			out += pair.fst().toString().substring(0, 4) + " " +  pair.fst().toString().substring(4, 7) + " " +
                   pair.fst().toString().substring(7, 10) + " " + pair.fst().toString().substring(10, 12) + " ";
			
			if (pair.fst().toString().length() > 12) {
				out += pair.fst().toString().substring(12, 15) + " " + pair.fst().toString().substring(15, 17);
			}
